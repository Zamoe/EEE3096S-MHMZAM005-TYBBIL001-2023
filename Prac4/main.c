...
unsigned long debounceDuration = 100;    // time for debouncing; so far best results with 100 - 200
uint8_t waveform = 0;
/* USER CODE END PD */
...
int main(void)
{
  ...
  //__HAL_DAC_ENABLE_ITHAL_DMA_Start(timer channel, LUT, destination, No. of points);
...
void wave_change(uint8_t wavein){
